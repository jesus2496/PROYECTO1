...
<div class="container" style="background-color: white;">
  ...
  <div class="row">
    <div class="col">
        <a href="{{ route('A_Serv')}}" class=" btn btn btn-primary">Regresar</a>
    </div>
    <div class="col">
         <!--ruta a la que va-->
        <form action="{{route('MuestraElPDF')}}" method="POST" target="_blank">
          @csrf
          ...
          <button class="btn btn btn-success" type="submit">Solicitar</button>
